...
//Se añade un elemento en una posición dada
console.log("Después de cambiar un elemento, queda así la lista:");
addAt(x,5,0);
...
//Devuelve el valor que modifica después de reemplazarlo
console.log("Valor borrado: (Enviado el 7, por ejemplo)");
valor=set(x,7);
console.log(valor);
